...
var StandardBagID = (function (_super) {
    ...
    StandardBagID.prototype.validate = function (nft_id) {
        return standardNftID_1.standard_nft_id.validate(nft_id) && _.startsWith(nft_id, "1000090000");
    };
    StandardBagID.prototype.bagIdToDGID = function (nft_id) {
        if (!this.validate(nft_id)) {
    ...
    StandardBagID.prototype.dgidToBagId = function (dgid) {
        if (standardDGID_1.DGID_TYPE.Invalid === standardDGID_1.standard_dgid.validate(dgid)) {
